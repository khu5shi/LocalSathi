...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-indigo-50/30 to-white mt-25">
      {/* Hero Section */}
          ...
          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-12 md:p-16 text-white shadow-2xl shadow-indigo-300/50 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <div className="text-3xl font-black mb-2">9</div>
      ...
      <section 
        ...
        className={`py-20 transition-all duration-1000 ${isVisible.values ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
      >
        <div className="max-w-6xl mx-auto px-6">
      ...
      >
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">Milestones that shaped LocalSathi</p>
          </div>

          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-indigo-500 to-purple-600 hidden md:block"></div>
              ...
              >
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-100">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="px-4 py-1 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full text-sm font-bold">
                      {milestone.year}
                    </div>
                  </div>
                ...
                {/* Timeline dot */}
                <div className="absolute top-8 left-1/2 w-4 h-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full -translate-x-1/2 border-4 border-white shadow-lg hidden md:block"></div>
              </div>
            ))}
          </div>
        </div>
